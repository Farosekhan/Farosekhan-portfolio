...
const Contact = () => {
  return (
    <>
        <div className="max-w-10xl mx-auto p-4 md:p-8 mt-30 mb-0 bg-gradient-to-r from-blue-50 to-purple-50 animate-slide-up">
      <div className="grid grid-cols-1   gap-6 items-start">
        

        <div className="space-y-20">
          <div className="bg-yellow-100 rounded-lg p-6 shadow">
            <h3 className="text-2xl font-semibold text-indigo-900 mb-6">Contact Information</h3>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 text-sm mb-1">My Location:</h4>
                  <p className="text-gray-600 text-sm">65 D/2 Poosari Street Chinthamani Trichy-2</p>
                  <p className="text-gray-600 text-sm"> TamilNadu India .</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">6383103257</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">farosekhan449@gmail.com</p>
                </div>
              </div>
            </div>
          </div>
